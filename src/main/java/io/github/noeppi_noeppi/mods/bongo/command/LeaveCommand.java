...
public class LeaveCommand implements Command<CommandSourceStack> {
    ...
    public int run(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        if (team == null) {
            throw new SimpleCommandExceptionType(new TranslatableComponent("bongo.cmd.team.leavonojoin")).create();
        }
        
        BongoChangeTeamEvent event = new BongoChangeTeamEvent(player, bongo, team, null, new TranslatableComponent("bongo.cmd.team.denied.leave"));
